...
Version  : 0.9.12.4.4
Release  : 44
URL      : https://cran.r-project.org/src/contrib/BayesFactor_0.9.12-4.4.tar.gz
Source0  : https://cran.r-project.org/src/contrib/BayesFactor_0.9.12-4.4.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657056033
